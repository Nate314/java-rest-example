...
PORTS="APP_PORT=8080 PMA_PORT=8082 MYSQL_PORT=3306"

print_urls() {
  echo "App:        http://localhost:$(port_of APP_PORT)"
  echo "Swagger UI: http://localhost:$(port_of APP_PORT)/swagger-ui.html"
  echo "phpMyAdmin: http://localhost:$(port_of PMA_PORT)"
